...
func (app *UIApp) registerPlaybackRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/assets/playback/hls/index.m3u8", app.handlePlaybackNativeAsset)
	mux.HandleFunc("/assets/playback/hls/segment.ts", app.handlePlaybackNativeAsset)
